...
//	private JButton[] tiles;
	...
	*/
	...
	public boolean winnerChecker(){
		...
		if(tiles[0].getValue() != 0 && tiles[0].getValue() == tiles[1].getValue() && tiles[1].getValue() == tiles[2].getValue()) {
			winner = true;
		} else if(tiles[3].getValue() != 0 && tiles[3].getValue() == tiles[4].getValue() && tiles[4].getValue() == tiles[5].getValue()) {
			winner = true;
		} else if(tiles[6].getValue() != 0 && tiles[6].getValue() == tiles[7].getValue() && tiles[7].getValue() == tiles[8].getValue()) {
			winner = true;
		} else if(tiles[0].getValue() != 0 && tiles[0].getValue() == tiles[3].getValue() && tiles[3].getValue() == tiles[6].getValue()) {
			winner = true;
		} else if(tiles[1].getValue() != 0 && tiles[1].getValue() == tiles[4].getValue() && tiles[4].getValue() == tiles[7].getValue()) {
			winner = true;
		} else if(tiles[2].getValue() != 0 && tiles[2].getValue() == tiles[5].getValue() && tiles[5].getValue() == tiles[8].getValue()) {
			winner = true;
		} else if(tiles[0].getValue() != 0 && tiles[0].getValue() == tiles[4].getValue() && tiles[4].getValue() == tiles[8].getValue()) {
			winner = true;
		} else if(tiles[2].getValue() != 0 && tiles[2].getValue() == tiles[4].getValue() && tiles[4].getValue() == tiles[6].getValue()) {
			winner = true;
		}
	...
	public boolean checkValue(){
		...
		if (i == Board.NUM_OF_TILES && !this.winnerChecker()) {
			this.addScore(1);
			this.addScore(2);
		}
